...
# Coding Workshop Part 1{background-color="#007CBA" style="text-align: left; font-size: 0.8em;"}
[Computational Reproducibility]{style="font-size: 1.5em; color: white;"}
...
# Computational Reproducibility <br> in Practice {background-color="#007CBA" style="text-align: center; font-size: 0.8em;"}{visibility="hidden"}

[Karissa Whiting <br>
June 1st, 2026 <br>
Summer Training Series <br>
Memorial Sloan Kettering <br>]{style="color: #FFB347;"}
